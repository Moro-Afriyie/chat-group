...
const Sidebar: React.FunctionComponent<ISidebarProps> = (props) => {
  return (
    <aside className="bg-sidebar-bg text-white h-full flex flex-col  basis-[20.25rem] w-[20.25rem] flex-shrink-0">
      ...
      <div className="h-full px-[1.25rem] py-4 flex-grow">
        <div className="relative mb-8">
          ...
          <input
            type="search"
            id="search"
            className="block w-full p-4 pl-10 text-sm text-light-grey text-white border-none bg-input-bg rounded-lg focus:border-none focus:ring-blue-500 focus:border-blue-500 "
            placeholder="Search"
            required
          />
        </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="uppercase flex gap-4 cursor-pointer text-lg font-bold items-center">
